...
updatead = s:taboption("advanced", Button, "updatead", translate("手动强制更新<br />Adblock Plus Host 列表"), translate(string.format("<strong><font color=\"blue\">Adblock Plus Host 规则：</font></strong>%s条<br />注意：因为需要下载并转换规则，后台可能需要60-120秒时间运行，请勿重复点击", ND)))
