...
s=m:section(TypedSection,"service",translate("Running Status"))
s.anonymous=true
...
o.rmempty=false
s=m:section(TypedSection,"service",translate("Advanced settings"))
s.anonymous=true
...
o.rmempty=false
o=s:option(Flag,"ssproxy",translate("Enable ssproxy"),translate("Allows pptp clients to ss proxy."))
o.rmempty=false
return m
